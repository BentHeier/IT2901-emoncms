...
arg=$(echo $jstring | php -r '$msg=json_decode(file_get_contents("php://stdin"));if(isset($msg->powerOut)) $arg="energyOut:0,powerOut:".$msg->powerOut; else $arg=""; if(isset($msg->powerin))  {if($arg!="")$arg=$arg.", "; $arg=$arg."energyIn:0,powerIn: ".$msg->powerin;}echo $arg;')
echo "arg:"$arg
