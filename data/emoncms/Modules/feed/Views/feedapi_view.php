...
<p><a href='<?php echo $path; ?>feed/create.json?name=Power&tag=Household&datatype=1&engine=5&options={"interval":10}'><?php echo $path; ?>feed/create.json?name=Power&tag=Household&datatype=1&engine=5&options={"interval":10}</a></p>
